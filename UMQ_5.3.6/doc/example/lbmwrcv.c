...
static const char *rcsid_example_lbmwrcv = "$Id: //UMprod/REL_5_3_6/29West/lbm/src/example/lbmwrcv.c#2 $";
...
const char Purpose[] = "Purpose: Receive messages using a wildcard receiver.";
const char Usage[] =
