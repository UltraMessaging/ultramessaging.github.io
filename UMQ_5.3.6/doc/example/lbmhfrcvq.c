...
"  (single receiver).
  ...
  Copyright (c) 2006-2014 Informatica Corporation  Permission is granted to licensees to use
...
static const char *rcsid_example_lbmhfrcvq = "$Id: //UMprod/REL_5_3_6/29West/lbm/src/example/lbmhfrcvq.c#2 $";
...
char purpose[] = "Purpose: Receive messages on a single topic using an event queue.";
char usage[] =
